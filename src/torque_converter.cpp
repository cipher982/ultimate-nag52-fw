...
TorqueConverter::TorqueConverter(uint16_t max_gb_rating)  {
    ...
    if (this->tcc_slip_map->init_status() != ESP_OK) { delete this->tcc_slip_map; this->tcc_slip_map = nullptr; }
    ...
    if (this->tcc_lock_map->init_status() != ESP_OK) { delete this->tcc_lock_map; this->tcc_lock_map = nullptr; }
    ...
    if (this->slip_rpm_target_map->init_status() != ESP_OK) { delete this->slip_rpm_target_map; this->slip_rpm_target_map = nullptr; }
