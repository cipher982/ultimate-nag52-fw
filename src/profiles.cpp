...
AbstractProfile::AbstractProfile(bool is_diesel, 
    ...
    if (this->upshift_table->init_status() != ESP_OK) { delete this->upshift_table; this->upshift_table = nullptr; }
    ...
    if (this->downshift_table->init_status() != ESP_OK) { delete this->downshift_table; this->downshift_table = nullptr; }
    ...
    if (this->upshift_time_map->init_status() != ESP_OK) { delete this->upshift_time_map; this->upshift_time_map = nullptr; }
    ...
    if (this->downshift_time_map->init_status() != ESP_OK) { delete this->downshift_time_map; this->downshift_time_map = nullptr; }
}
